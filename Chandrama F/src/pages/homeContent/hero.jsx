  ...
  return (
    <div className="w-full min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0">
          {[...Array(25)].map((_, i) => (
            <div
              key={i}
              className="absolute w-2 h-2 rounded-full bg-yellow-400/70 animate-float-particle"
              style={{
        ...
        {properties.map((item) => (
          <SwiperSlide key={item.id}>
            <div className="relative w-full h-full flex items-center justify-between px-8 lg:px-16 pt-10">
              ...
              {/* Text */}
              <div className="relative z-20 flex-1 max-w-2xl text-white">
                {/* Category */}
                ...
                <h1 className="text-4xl lg:text-5xl font-bold mb-6 leading-tight animate-fade-in">
                  <span className="bg-gradient-to-r from-yellow-300 via-yellow-500 to-yellow-700 bg-clip-text text-transparent animate-gradient-text">
                    {item.name}
                  </span>
                </h1>
                ...
                {/* Description */}
                <p
                  className="text-xl text-gray-300 mb-8 leading-relaxed max-w-lg animate-fade-in"
                ...
                >
                  <button
                    ...
                    className="group px-8 py-4 bg-gradient-to-r from-yellow-600 to-yellow-800 hover:from-yellow-700 hover:to-yellow-900 rounded-lg font-semibold text-black transition-all duration-300 flex items-center justify-center shadow-lg hover:shadow-xl hover:shadow-yellow-400/25 transform hover:scale-105"
                  >
      ...
      <style jsx>{`
        ...
        /* Keep all animations but tuned for gold */
        @keyframes fade-in {
          from {
            opacity: 0;
        ...
        @keyframes neon-glow {
          0%,100% { box-shadow: 0 0 5px gold, 0 0 10px gold, 0 0 15px gold; }
          50% { box-shadow: 0 0 15px gold, 0 0 25px gold, 0 0 35px gold; }
        }
        ...
        @keyframes color-float {
          0%,100% {
            ...
            background: linear-gradient(45deg, rgba(250,204,21,0.3), rgba(180,140,10,0.3));
          }
          50% {
            transform: rotate(3deg) translateY(-15px);
            background: linear-gradient(45deg, rgba(180,140,10,0.3), rgba(250,204,21,0.3));
          }
        }
