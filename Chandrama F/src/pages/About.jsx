...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="py-16 bg-black text-yellow-300"
    >
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <motion.div className="md:w-1/2" variants={itemVariants}>
              ...
              <motion.p
                className="text-yellow-300 mb-4 leading-relaxed"
                variants={itemVariants}
              >
              ...
              <motion.p
                className="text-yellow-300 mb-6 leading-relaxed"
                variants={itemVariants}
              >
              ...
              <motion.div
                ...
                variants={itemVariants}
              >
                {["Verified Listings", "Legal Assistance", "Site Visits", "Financing Options"].map((feature, idx) => (
