        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-8">
            <motion.div className="md:w-1/2" variants={itemVariants}>
              <div className="h-64 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-lg shadow-lg overflow-hidden">
                <div className="h-full w-full bg-gradient-to-r from-emerald-400 to-teal-500 flex items-center justify-center">
            ...
            <motion.div className="md:w-1/2" variants={itemVariants}>
              ...
              >
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Site Visits</span>
                </div>
              ...
              <motion.div className="mt-8" variants={itemVariants}>
                <button className="bg-emerald-500 hover:bg-emerald-600 text-white font-medium py-2 px-6 rounded-lg transition duration-300 transform hover:-translate-y-1">
                  Learn More
                </button>
              </motion.div>
            </motion.div>
